...
세부페이지 5개의 내용·배치와 공통 JS 유지. 공통 CSS의 배경 색상은 브랜드 팔레트로 통일.
...
- 기존 세부페이지 5개 HTML 및 공통 JS 원본 바이트 동일. 공통 CSS는 색상값만 변경.
...
## V6.2 전체 페이지 색상 통일
About / Service / Space / Contact / Guide 5개 세부페이지의 공통 배경·보조 영역·스크롤 헤더·모바일 메뉴·전화 버튼·사진 캡션을 쿨 화이트와 블루 그레이로 통일했습니다. 공통 CSS 색상값만 수정했으며 HTML·JS·메인 디자인·배치·콘텐츠는 V6.1과 동일합니다.
